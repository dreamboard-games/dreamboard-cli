---
title: "Static views"
description: "Use defineStaticView for immutable session-scoped projection such as decorated board topology."
---
...
Those belong in [Views](/docs/authoring/views), interactions, or table queries.
