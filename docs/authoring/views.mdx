---
title: "Views"
description: "Use defineView to project dynamic player-facing state for UI and clients."
---
...
Use `defineView` for data that can change during a session. Use [Static views](/docs/authoring/static-views) for manifest-derived payloads that do not change after session initialization.
