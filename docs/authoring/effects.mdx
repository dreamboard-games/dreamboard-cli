---
title: "Effects"
description: "Use defineEffect and fx.effect for engine-side dice rolls and shared-zone shuffles."
---
...
Use [Interactions](/docs/authoring/interactions) with `promptInput` for addressed player requests. Prompts are player submissions; effects are runtime instructions.
