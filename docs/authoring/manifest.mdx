---
title: "Manifest"
description: "Use defineTopologyManifest to declare the static table model for a Dreamboard game."
---
...
- [Manifest fields](/docs/authoring/manifest-fields) for schemas, homes, visibility, and strict slots.
- [Boards and topology](/docs/authoring/boards-and-topology) for board layouts and tiled IDs.
- [Game contract](/docs/authoring/game-contract) for binding the manifest into reducer state.
