---
title: "Board surfaces"
description: "Render boards and route board target interactions."
---
...
See [Inputs and targets](/docs/authoring/inputs-and-targets) for authoring the
