...
description: "Understand the generated UI contract, UI SDK, and host runtime boundaries."
---
...
| Need | Use |
| --- | --- |
| Standard mobile-first layout | [WorkspaceGameShell](/docs/ui/game-shell) |
| Custom board geometry with board target clicks | [Board surfaces](/docs/ui/board-surfaces) |
| Card hand or card action rendering | [Hand surfaces](/docs/ui/hand-surfaces) |
| Prompt or choice rendering | [Prompts and choices](/docs/ui/prompts-and-choices) |
| One-off visual override for an interaction | [Custom renderers](/docs/ui/custom-renderers) |
| Presentational cards, hands, grids, dice, players, and phase UI | [UI components](/docs/ui/components) |
