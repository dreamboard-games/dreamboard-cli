...
const SDK_PACKAGE_PATHS = {
  ...
  "@dreamboard/testing": ["packages", "testing", "package.json"],
...
const SDK_DEPENDENCY_RANGES = {
  ...
  "@dreamboard/testing": resolveSdkDependencyRange("@dreamboard/testing"),
  "@dreamboard/ui-sdk": resolveSdkDependencyRange("@dreamboard/ui-sdk"),
} as const;

const FRAMEWORK_SCRIPTS = {
  dev: "dreamboard dev",
  "test:ui": "tsx --conditions=bun --test test/ui/**/*.test.tsx",
...
export async function scaffoldStaticWorkspace(
  ...
  await writeGeneratedTestingStubs(generatedDir);
...
async function writeGeneratedTestingStubs(generatedDir: string): Promise<void> {
...
async function buildRootPackageJson(
  ...
  const frameworkDevDependencies = {
    ...
    "@dreamboard/testing":
      sdkDependencyRanges["@dreamboard/testing"] ??
      SDK_DEPENDENCY_RANGES["@dreamboard/testing"],
