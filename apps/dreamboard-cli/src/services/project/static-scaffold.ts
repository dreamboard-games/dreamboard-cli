...
const DREAMBOARD_UPDATE_COMMAND = "dreamboard update";
...
export async function assertCliStaticScaffoldComplete(
  ...
  throw new Error(
    `CLI static scaffold is incomplete (${problems.join("; ")}). Run \`${DREAMBOARD_UPDATE_COMMAND}\` to restore the missing static files before pushing.`,
  );
}
